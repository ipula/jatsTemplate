...
class ArticleFrontTest extends \PKP\tests\PKPTestCase
{
    ...
    public function testCreate(){
        ...
        self::assertXmlStringEqualsXmlFile('plugins/generic/jatsTemplate/tests/data/frontElement.xml',$article->saveXML($xml));
    }
    ...
    public function testCreateJournalMetaElements(){
        ...
        self::assertXmlStringEqualsXmlFile('plugins/generic/jatsTemplate/tests/data/journalMetaElement.xml',$article->saveXML($xml));
    }
    ...
    public function testCreateArticleMetaElements(){
        ...
        self::assertXmlStringEqualsXmlFile('plugins/generic/jatsTemplate/tests/data/articleMetaElement.xml',$article->saveXML($xml));
    }
