...
class ArticleFrontTest extends \PKP\tests\PKPTestCase
{
    ...
    public function testCreate(){
        ...
        self::assertXmlStringEqualsXmlFile($this->xmlFilePath.'frontElement.xml',$article->saveXML($xml));
    }
    ...
    public function testCreateJournalMeta(){
        ...
        self::assertXmlStringEqualsXmlFile($this->xmlFilePath.'journalMetaElement.xml',$article->saveXML($xml));
    }
    ...
    public function testCreateArticleMeta(){
        ...
        self::assertXmlStringEqualsXmlFile($this->xmlFilePath.'articleMetaElement.xml',$article->saveXML($xml));
    }
    ...
    public function testCreateJournalMetaJournalTitleGroup(){
        ...
        self::assertXmlStringEqualsXmlFile($this->xmlFilePath.'journalMeta_JournalTitleGroupElement.xml',$article->saveXML($xml));
    }
    ...
    public function testCreateArticleCategories(){
        ...
        self::assertXmlStringEqualsXmlFile($this->xmlFilePath.'articleMetaArticle_CategoriesElement.xml',$article->saveXML($xml));
    }
    ...
    public function testCreateArticleContribGroup(){
        ...
        self::assertXmlStringEqualsXmlFile($this->xmlFilePath.'articleMetaArticle_ContribGroupElement.xml',$article->saveXML($xml['contribGroupElement']));
    }
