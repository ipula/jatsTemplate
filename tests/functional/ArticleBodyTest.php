...
class ArticleBodyTest extends PKPTestCase
{
    ...
    public function testCreate(){
        ...
        $xml = $articleBodyElement->create($submission,$article);
        self::assertXmlStringEqualsXmlString('<body/>',$article->saveXML($xml));
    }

    /**
     * need to enable index[application/pdf] in config.inc.php file
     * testing body element if file exists
     * @throws \DOMException
     */
...
//        $articleBodyElement = new ArticleBody();
//        $xml = $articleBodyElement->create($submission,$article);
//        self::assertXmlStringEqualsXmlFile($this->xmlFilePath.'articleBodyElement.xml',$article->saveXML($xml));
//    }
}
